...
* First copy the release plugin from my repo to your project here are the places to note
    - https://github.com/Mark7625/Cyphorax-Client-Public/tree/master/buildSrc <- Copy this whole dir
    - https://github.com/Mark7625/Cyphorax-Client-Public/blob/master/build.gradle.kts
...
Make sure CC is selected and replace 'Cyphorax' with 'MyCoolName' MAKE SURE ITS CAPS E same with the server name
...
Once you have pushed your files to github, github actions will build your launcher you can then find them under the workflow action it runs EG: https://github.com/Cyphorax-Community/Runelite-Launcher-rsps/actions/runs/3014844052
